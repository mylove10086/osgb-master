...
jpeg_add_quant_table (j_compress_ptr cinfo, int which_tbl,
		      ...
		      int scale_factor, booleans force_baseline)
...
GLOBAL(void)
jpeg_default_qtables (j_compress_ptr cinfo, booleans force_baseline)
...
GLOBAL(void)
jpeg_set_quality (j_compress_ptr cinfo, int quality, booleans force_baseline)
/* Set or change the 'quality' (quantization) setting, using default tables.
